...
# Refer to the link - https://github.com/Azure/autorest.csharp
 ...
 autorest --input-file=filesecurity.swagger.json --output-folder=. --namespace=Kmd.Logic.FileSecurity.Client --csharp --legacy --override-client-name=InternalClient --add-credentials
